...
sdr_pvt_afs.o  : $(SRC)/sdr_pvt_afs.c
	$(CC) -c $(CFLAGS) $(SRC)/sdr_pvt_afs.c
...
sdr_ldpc_afs.o : $(SRC)/sdr_ldpc_afs.c
	$(CC) -c $(CFLAGS) $(SRC)/sdr_ldpc_afs.c
...
sdr_ldpc_afs.o : $(SRC)/pocket_sdr.h
